		...
		<div class="col-12">
			<div class="card-box">
				...
				<form class="form-horizontal" method="post" action="developerDetails">
					<input type="hidden" class="form-control" id="simpleinput" value="${developer.id }"
					...
					<div class="form-group row">
						<label class="col-sm-2 col-form-label" for="simpleinput">Pays</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="simpleinput"
								value="${developer.country }" name="country" required>
						</div>
					</div>
