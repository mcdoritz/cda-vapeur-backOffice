	...
	<div class="row">
		<div class="col-12">
			<div class="card-box">
				...
				<form class="form-horizontal" method="post" action="platformDetails">
				<input type="hidden" class="form-control" id="simpleinput" value="${platform.id }"
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="simpleinput"
								value="${platform.acronym }" name="acronym" max=5 min=3 required>
						</div>
					</div>
